...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-white mb-2">Bejelentkezés</h1>
      <p className="text-gray-400 mb-8">Lépj be a fiókodba.</p>
        ...
        <div className="bg-red-500/20 border border-red-500/30 text-red-300 px-4 py-3 rounded-lg mb-6">
          ...
          {showResend && (
            <button
              ...
              className="block mt-2 text-sm text-primary-400 hover:underline font-medium"
            >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <Link
            ...
            className="block text-sm text-primary-400 hover:underline mt-1"
          >
            Elfelejtett jelszó?
          </Link>
        </div>
      ...
      <p className="text-center text-gray-400 mt-6">
        Nincs még fiókod?{' '}
        <Link href="/regisztracio" className="text-primary-400 hover:underline">
          Regisztráció
        </Link>
      </p>
    </div>
