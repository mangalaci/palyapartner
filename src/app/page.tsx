      ...
      <section className="relative bg-navy-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-primary-500">sportpartnered</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Regisztrálj</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Keress partnert</h3>
            <p className="text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Sportolj!</h3>
            <p className="text-gray-600">
