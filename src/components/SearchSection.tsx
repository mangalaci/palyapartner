    ...
    <section className="border-t border-b border-white/10">
        ...
        <form onSubmit={handleSearch} className="space-y-3">
          <div className="flex flex-col sm:flex-row gap-3">
            <select
              ...
              className="flex-1 px-4 py-3 border border-white/40 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none bg-black/40 text-white font-heading text-base"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold flex items-center gap-2" style={{ color: '#003d1a' }}>
            <svg className="w-7 h-7" style={{ color: '#003d1a' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
